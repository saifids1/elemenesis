    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden px-6 py-24 text-[#ECE9E2]">
        ...
        >
          ...
          >
            Delivering high-performance construction chemicals, additives, and
            specialty materials that enhance strength, durability, and
            sustainability.
          </motion.p>
        </motion.div>
      </section>
        ...
        <section className=" bg-white md:px-20">
          <div className="container mx-auto px-4">
            ...
            <div className="relative mb-7">
              ...
              <div className="absolute bottom-[70px] left-0 w-full h-[4px] bg-[#096F72] rounded-full" />
              ...
              <div className="relative z-10 grid grid-cols-7 gap-0">
                {tabs.map((tab, index) => (
                  <button
                    ...
                    className={`relative h-[70px] px-2 text-xs lg:text-sm font-bold uppercase text-white transition-all duration-300 ${
                      active === index
                        ? "bg-[#064D50] shadow-xl"
