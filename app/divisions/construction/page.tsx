...
const tabs = [
  ...
  {
    title: "Sealant and Waterproofing",
        ...
        <section className=" bg-white md:px-20">
          <div className="container mx-auto px-4">
            ...
            <div className="relative mb-7">
              ...
              {/* Tabs */}
              <div className="relative z-10 flex flex-wrap justify-center gap-2 md:gap-0">
                {tabs.map((tab, index) => (
                  <button
                    key={index}
                    onClick={() => setActive(index)}
                    className={`relative h-[60px] min-w-[20.28%] cursor-pointer px-6 text-sm md:text-balance font-bold uppercase text-white transition-all duration-300 hover:scale-105 ${
                      active === index
