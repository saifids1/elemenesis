...
import { ArrowRight, Paintbrush,Wheat } from "lucide-react";
...
const tabs = [
  {
    title: "Poultry(Brolier  and Layer Feed)",
      ...
      {/* Hero Section with Gradient Background */}
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden px-6 py-24 text-[#ECE9E2]">
          ...
          >
            ...
            >
              <span className=" text-white"> Animal Feed </span>
            </motion.h1>
            ...
            >
             Comprehensive range of high-performance coatings, inks, adhesives, and specialty chemicals for diverse industrial applications worldwide
            </motion.p>
          </motion.div>
        </section>
        ...
        <section className=" bg-white md:px-20">
          <div className="container mx-auto px-4">
            ...
            <div className="relative mb-7">
              ...
              <div className="absolute bottom-[60px] left-0 w-full h-[4px] bg-gradient-to-r from-[#00CCAA] via-[#00B9CC] to-[#0099FF] rounded-full" />

              {/* Tabs */}
              <div className="relative z-10 flex flex-wrap justify-center gap-2 md:gap-2">
                {tabs.map((tab, index) => (
                  <button
                    key={index}
                    onClick={() => setActive(index)}
                    className={`relative h-[60px] min-w-[160px] cursor-pointer px-6 text-sm md:text-balance font-bold uppercase text-white transition-all duration-300 hover:scale-105 ${
                      active === index
                        ? "bg-[#064D50] shadow-xl"
