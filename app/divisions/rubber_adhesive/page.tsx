...
import { ArrowRight, Paintbrush, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden px-6 py-24 text-[#ECE9E2]">
        ...
        >
          ...
          >
            <span className=" text-white"> Rubber / Adhesive</span>
          </motion.h1>
          ...
          >
            Delivering advanced rubber compounds, adhesives, and specialty
            additives designed to enhance durability, flexibility, and bonding
            strength across industrial applications.
          </motion.p>
        </motion.div>
      </section>
