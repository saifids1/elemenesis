...
import { ArrowUpRight, ShoppingBag, Sparkles, Leaf } from "lucide-react";
  ...
  return (
    <>
     ...
     <div className="min-h-screen bg-[#F9F6F0] text-[#1E1E1E] font-sans antialiased selection:bg-[#4A8F3C] selection:text-white">
        ...
        <section className="relative overflow-hidden bg-[#F9F6F0] px-4 py-16 sm:px-6 lg:px-8 lg:pb-20 lg:pt-5">
          ...
          <div className="relative z-10 mx-auto max-w-7xl">
            <div className="mb-14 text-center">
              ...
              <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-gray-600">
                Explore premium natural products crafted for wellness, purity,
                and everyday health.
              </p>
            </div>
