    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F5] text-[#1E1E1E] font-sans antialiased selection:bg-[#00cba9] selection:text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden opacity-[0.45] select-none">
          <svg className="w-full h-full min-w-[1440px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
            <defs>
            ...
            <line x1="150" y1="200" x2="350" y2="450" stroke="#00cba9" strokeOpacity="0.08" strokeWidth="1" strokeDasharray="4 4" />
            <line x1="350" y1="450" x2="750" y2="250" stroke="#0D231D" strokeOpacity="0.06" strokeWidth="1" />
            <line x1="750" y1="250" x2="1100" y2="600" stroke="#D4AF37" strokeOpacity="0.08" strokeWidth="1.5" strokeDasharray="6 3" />
            <line x1="1100" y1="600" x2="1300" y2="300" stroke="#00cba9" strokeOpacity="0.05" strokeWidth="1" />
            <line x1="350" y1="450" x2="200" y2="750" stroke="#D4AF37" strokeOpacity="0.05" strokeWidth="1" />

            {/* Kinetic Floating Node Cluster 1 */}
            <g>
              <motion.circle cx="150" cy="200" r="40" fill="url(#node-glow-teal)" {...floatAnimation(16, 0, 30, -40)} />
              <motion.circle cx="150" cy="200" r="3" fill="#00cba9" {...floatAnimation(16, 0, 30, -40)} />
            </g>

            {/* Kinetic Floating Node Cluster 2 */}
            <g>
              <motion.circle cx="350" cy="450" r="60" fill="url(#node-glow-gold)" {...floatAnimation(22, 2, -45, 35)} />
              <motion.circle cx="350" cy="450" r="4.5" fill="#D4AF37" {...floatAnimation(22, 2, -45, 35)} />
            </g>

            {/* Kinetic Floating Node Cluster 3 */}
            <g>
              <motion.circle cx="750" cy="250" r="50" fill="url(#node-glow-teal)" {...floatAnimation(19, 4, 50, 25)} />
              <motion.circle cx="750" cy="250" r="3.5" fill="#00cba9" {...floatAnimation(19, 4, 50, 25)} />
            </g>

            {/* Kinetic Floating Node Cluster 4 */}
            <g>
              <motion.circle cx="1100" cy="600" r="70" fill="url(#node-glow-teal)" {...floatAnimation(25, 1, -25, -60)} />
              <motion.circle cx="1100" cy="600" r="4" fill="#0D231D" stroke="#00cba9" strokeWidth="1" {...floatAnimation(25, 1, -25, -60)} />
            </g>

            {/* Kinetic Floating Node Cluster 5 */}
            <g>
              <motion.circle cx="1300" cy="300" r="45" fill="url(#node-glow-gold)" {...floatAnimation(17, 3, 40, -20)} />
              <motion.circle cx="1300" cy="300" r="3" fill="#D4AF37" {...floatAnimation(17, 3, 40, -20)} />
            </g>

            {/* Kinetic Floating Node Cluster 6 */}
            <g>
              <motion.circle cx="200" cy="750" r="55" fill="url(#node-glow-teal)" {...floatAnimation(21, 5, -30, -35)} />
              <motion.circle cx="200" cy="750" r="3" fill="#00cba9" {...floatAnimation(21, 5, -30, -35)} />
            </g>
          </svg>
        </div>
        ...
        <div className="max-w-6xl mx-auto py-24 px-6 relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="lg:col-span-5 flex flex-col justify-between space-y-12">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 mt-5 text-gray-900 transition-all duration-700 delay-200 ">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4 group cursor-pointer">
                    ...
                    <div>
                      <h3 className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Our Office</h3>
                      <p className="mt-1.5 text-neutral-700 font-medium leading-relaxed group-hover:text-neutral-900 transition-colors duration-300">
                        Office No-215, Frij All Murar<br />
                        Deira, DUBAI (UAE)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 group cursor-pointer">
                    ...
                    <div>
                      <h3 className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Call Us</h3>
                      <a href="tel:+971543471546" className="mt-1.5 text-neutral-800 font-bold block hover:text-[#00cba9] transition-colors duration-300 text-lg tracking-tight">
                        +971 54 347 1546
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 group cursor-pointer">
                    ...
                    <div>
                      <h3 className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Email Us</h3>
                      <a href="mailto:info@elemensisllc.com" className="mt-1.5 text-neutral-800 font-bold block hover:text-[#00cba9] transition-colors duration-300 text-lg tracking-tight">
              ...
              <div className="p-6 bg-gradient-to-tr from-[#FAF8F5] to-[#F3F0E6] rounded-2xl border border-neutral-200/50 text-xs text-neutral-500 leading-relaxed font-medium shadow-[inset_0_2px_4px_rgba(0,0,0,0.015)] relative overflow-hidden group">
                ...
                <span className="text-[#0D231D] font-bold block mb-1">Corporate Operations:</span> 
                Inquiries are parsed directly to our multi-sector fulfillment teams. Expect a strategic response within 24 business hours.
              </div>
            </motion.div>
            ...
            >
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-xs font-bold text-neutral-400 uppercase tracking-wider">Full Name</label>
                    <input 
                      type="text" 
                      id="name" 
                  ...
                  <div>
                    <label htmlFor="email" className="block text-xs font-bold text-neutral-400 uppercase tracking-wider">Email Address</label>
                    <input 
                      type="email" 
                      id="email" 
                      className="mt-2 block w-full rounded-xl bg-white border border-neutral-200 text-neutral-800 px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#00cba9] focus:border-transparent transition-all duration-300 shadow-[0_2px_8px_rgba(13,35,29,0.01)] focus:shadow-[0_4px_16px_rgba(0,203,169,0.06)]"
                ...
                <div>
                  <label htmlFor="subject" className="block text-xs font-bold text-neutral-400 uppercase tracking-wider">Subject</label>
                  <input 
                    type="text" 
                    id="subject" 
                    className="mt-2 block w-full rounded-xl bg-white border border-neutral-200 text-neutral-800 px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#00cba9] focus:border-transparent transition-all duration-300 shadow-[0_2px_8px_rgba(13,35,29,0.01)] focus:shadow-[0_4px_16px_rgba(0,203,169,0.06)]"
                ...
                <div>
                  <label htmlFor="message" className="block text-xs font-bold text-neutral-400 uppercase tracking-wider">Message</label>
                  <textarea 
                    id="message" 
                    rows={5} 
