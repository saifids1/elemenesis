              ...
              {values.map((val, idx) => (
                <div
                  ...
                  className={`group relative p-6 rounded-2xl border transition-all duration-300 cursor-pointer flex items-center gap-5 ${
                    activeValue === idx
                      ? "bg-white border-slate-200 shadow-[0_15px_35px_-12px_rgba(0,0,0,0.06)] scale-[1.01]"
                ...
                >
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-transform duration-500 group-hover:scale-105 ${
                    activeValue === idx ? val.bgLight : "bg-slate-50"
                  }`}>
                    <val.icon className={`w-5 h-5 ${activeValue === idx ? val.solidColor : "text-slate-400"}`} />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <h4 className="text-base font-bold text-[#111827] tracking-tight">{val.title}</h4>
                      <span className="text-xs font-mono font-bold text-slate-300">{val.num}</span>
                    </div>
            ...
            <div className="lg:col-span-7">
              <div className="relative h-full min-h-[400px] bg-white border border-slate-200/80 rounded-[32px] shadow-[0_30px_70px_-20px_rgba(0,0,0,0.06)] p-8 md:p-12 flex flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10 pt-8 border-t border-slate-100 flex items-center justify-between text-xs font-mono text-slate-400">
                  ...
                  <span className={`font-bold uppercase ${values[activeValue].solidColor}`}>System Active</span>
                </div>
              </div>
            </div>
